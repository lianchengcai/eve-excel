package net.evecom.excel.config;
...
public class FieldValue {
	...
	/** 定义操作有效范围 all全部,import导入,export导出 */
	private OperateValidEnum operateValid = OperateValidEnum.ALL;
	...
	public OperateValidEnum getOperateValid() {
		return operateValid;
	}

	public void setOperateValid(OperateValidEnum operateValid) {
